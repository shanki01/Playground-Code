...
class BLESimplePeripheral:
    def __init__(self, ble, type = 'UART', name="SPIKE"):
        self.type = type
        self._services = [_UART_UUID] if type == 'UART' else [_MIDI_UUID]
        self._ble = ble
    ...
    def _advertise(self, name, interval_us=100000):
        print("Starting advertising as", name)
        self._payload = advertising_payload(name=name, services=self._services)
